    ...
    <div className="flex justify-center items-center h-full mt-10 mb-10">
      <div className="bg-white p-8 rounded-lg shadow-lg max-w-md w-full border-t-4 border-primary-500 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center mb-6 mt-4">
          ...
          <p className="text-slate-500 text-sm mt-1">Join HealthConnect today</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="relative z-10 space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-1">Phone Number <span className="text-slate-400 font-normal">(Optional, for SMS recovery)</span></label>
            <input 
          ...
          {formData.role === 'doctor' && (
            <div className="space-y-4 bg-slate-50 p-4 rounded-md border border-slate-200 mt-4">
              <h3 className="font-semibold text-slate-700 text-sm pb-2 border-b border-slate-200">Doctor Verification Details</h3>
              ...
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-1">License Issuing Authority *</label>
                <input 
              ...
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-1">Medical License Document (PDF/Image) *</label>
                {!formData.document ? (
                  <>
                    <input 
                    ...
                    />
                    <p className="text-xs text-slate-500 mt-1">Clear scan of your medical license. Max 5MB.</p>
                  </>
                ) : (
                  <div className="border border-slate-300 rounded-md p-3 bg-slate-50 relative group">
                    {documentPreview ? (
                      ...
                      <div className="flex items-center justify-center bg-slate-200 rounded-md h-20 mb-2">
                        <span className="text-slate-600 font-medium">PDF Document Selected</span>
                      </div>
                    )}
              ...
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-1">Live Selfie for Identity Verification *</label>
                ...
                <div className="border border-slate-300 rounded-md bg-white overflow-hidden">
                  {!isCameraOpen && !photoPreview && (
                    <div className="p-6 flex flex-col items-center justify-center text-center">
                      ...
                      <p className="text-sm font-medium text-slate-700 mb-1">Live Identity Check</p>
                      <p className="text-xs text-slate-500 mb-4 max-w-[250px]">To verify your medical credentials, please take a clear, well-lit photo of your face right now.</p>
                      <button 
                        type="button" 
        ...
        <div className="mt-6 text-center text-sm text-slate-600 relative z-10">
          Already have an account? <Link to="/login" className="text-primary-600 font-semibold hover:underline">Sign in here</Link>
        </div>
      </div>
    </div>
  );
