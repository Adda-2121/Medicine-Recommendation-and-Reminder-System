 ...
 * NO AI, NO NLP. Input: reason key → Output: doctor type + specialty.
 *
 * Rules:
 ...
 */
function triageRoute(reasonKey) {
  ...
  if (!rule) {
    ...
    return {
      doctorType: 'gp',
      specialty: null,
      routingNote: 'A General Practitioner will assess your condition.',
    };
  }
  return {
...
module.exports = { TRIAGE_REASONS, triageRoute };
